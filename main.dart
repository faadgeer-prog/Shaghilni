    ...
    return Container(
      ...
      child: Row(
        children: [
          CircleAvatar(
            radius: 27,
            backgroundColor: scheme.onPrimary.withValues(alpha: .12),
      ...
      slivers: [
        ...
        SliverPadding(
          ...
          sliver: SliverList.separated(
            ...
            separatorBuilder: (_, __) => const SizedBox(height: 12),
            itemBuilder: (_, i) => TaskCard(task: demoTasks[i]),
          ),
        ),
      ],
    );
              ...
              children: [
                Card(
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        const Icon(Icons.wallet, size: 42),
                ...
                Card(
                  child: ListTile(
                    ...
                    subtitle: const Text('لا توجد عمليات حتى الآن'),
        ...
        SliverAppBar.large(
          ...
          actions: [
            IconButton(
              onPressed: () {
                final state =
                    context.findAncestorStateOfType<_ShaghilniAppState>();
                state?._toggleTheme();
              },
          ...
          sliver: SliverToBoxAdapter(
            child: Column(
              children: [
                ...
                const SizedBox(height: 4),
                const Text('أكمل بياناتك عشان تبدأ'),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  _Tag(icon: Icons.schedule, text: task.time),
                  const SizedBox(width: 8),
                  _Tag(icon: Icons.near_me_outlined, text: task.distance),
                ],
              ),
            ],
          ),
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  CircleAvatar(radius: 30, child: Icon(task.icon, size: 28)),
                  const SizedBox(height: 16),
                  Text(
                    task.title,
                    style: Theme.of(context)
                  ...
                  _InfoRow(Icons.schedule, task.time),
                  _InfoRow(Icons.payments_outlined, '${task.price} جنيه'),
                ],
              ),
            ),
          ),
          ...
          FilledButton.icon(
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('تم إرسال طلب قبول المهمة بنجاح'),
                ),
              );
            },
...
class _CreateTaskPageState extends State<CreateTaskPage> {
  ...
  void _publish() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('تم نشر المهمة بنجاح')),
    );
        ...
        child: ListView(
          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (v) =>
                  v == null || v.trim().isEmpty ? 'اكتب عنوان المهمة' : null,
            ),
            const SizedBox(height: 12),
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'اكتب التفاصيل المطلوبة بوضوح',
              ),
              validator: (v) =>
                  v == null || v.trim().isEmpty ? 'اكتب وصف المهمة' : null,
            ),
            const SizedBox(height: 12),
            TextFormField(
              ...
              validator: (v) =>
                  v == null || v.trim().isEmpty ? 'حدد الموقع' : null,
            ),
            const SizedBox(height: 12),
            TextFormField(
              controller: _price,
              ...
              validator: (v) =>
                  v == null || v.trim().isEmpty ? 'حدد المبلغ' : null,
            ),
...
const demoTasks = <Task>[
  Task(
    ...
    description: 'محتاج شخص قريب يصور واجهة محل بعدة صور واضحة.',
    location: 'بحري',
    time: 'اليوم',
    distance: '1.2 كم',
    price: 5000,
  ...
  Task(
    title: 'توصيل مستندات',
    description: 'استلام ظرف وتسليمه في الموقع المحدد بأمان.',
    location: 'الخرطوم',
    time: 'خلال ساعتين',
    distance: '2.4 كم',
    price: 7000,
  ...
  Task(
    title: 'إدخال بيانات',
    description: 'إدخال مجموعة بيانات بسيطة في ملف Excel.',
    location: 'عن بُعد',
    time: 'مرن',
    distance: 'عن بُعد',
    price: 10000,
  ...
  Task(
    ...
    description: 'شراء غرض محدد وتسليمه في نقطة متفق عليها.',
    location: 'أم درمان',
    time: 'اليوم',
    distance: '3.1 كم',
    price: 6000,
